...
((RUN_TIME_MIN=10))
((WAIT_INT_SECS=5))
((NUM_TRIALS=${RUN_TIME_MIN} * 60 / ${WAIT_INT_SECS}))
...
# IMG_FILE_LIST='imgLists_val/cat.txt'
# IMG_FILE_LIST='imgLists_val/dog.txt'
# IMG_FILE_LIST='imgLists_val/laptop.txt'
# IMG_FILE_LIST='imgLists_val/person.txt'
# IMG_FILE_LIST='imgLists_val/potted_plant.txt'

IMG_DIR=~/Projects/coco/flowers
IMG_FILE_LISTS=('imgLists_flowers/daisy.txt') # 'imgLists_flowers/dandelion.txt'
# IMG_FILE_LISTS=('imgLists_flowers/dandelion.txt' 'imgLists_flowers/roses.txt' 'imgLists_flowers/sunflowers.txt' 'imgLists_flowers/tulips.txt')
# IMG_FILE_LIST='imgLists_flowers/daisy.txt'
# IMG_FILE_LIST='imgLists_flowers/dandelion.txt'
# IMG_FILE_LIST='imgLists_flowers/roses.txt'
# IMG_FILE_LIST='imgLists_flowers/sunflowers.txt'
# IMG_FILE_LIST='imgLists_flowers/tulips.txt'
...
run_trial() {
    ...
    for IMG_FILE in $(cat ${IMG_FILE_LIST}); do
        ...
        if [ $TRIAL_COUNTER -ge $NUM_TRIALS ] ; then break; else TRIAL_COUNTER=$((TRIAL_COUNTER+1)); fi
...
print_resource_line() {
    ...
    sleep $((${WAIT_INT_SECS} - ${WAIT_INT_OFFSET}))
...
run_alt_segment() {
    ...
    for ALT_COUNTER in {1..5}
    do
        TRIAL_COUNTER=${ORIG_TRIAL_COUNTER}.${ALT_COUNTER}
