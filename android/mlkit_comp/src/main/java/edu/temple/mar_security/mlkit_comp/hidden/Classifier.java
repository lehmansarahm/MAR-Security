...
public abstract  class Classifier {
    ...
    protected Classifier(Activity activity ) throws IOException {
        ...
        Log.d(MainActivity.TAG, "Created a Tensorflow Lite Image Classifier.");
    }
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap ) {
        ...
        Trace.endSection();
        Log.v(MainActivity.TAG, "Timecost to load the image: " + (endTimeForLoadImage - startTimeForLoadImage));
        ...
        Trace.endSection();
        Log.v(MainActivity.TAG, "Timecost to run model inference: " + (endTimeForReference - startTimeForReference));
